...
public class LogradouroViewModel : INotifyPropertyChanged
{
    ...
    public void Add(Logradouro dado)
    {
        ...
        using var comando = factory.CreateCommand(); //Cria comando
        comando!.Connection = conexao; //Atribui conexão
        var cep = comando.CreateParameter();//Adiciona parâmetro (@campo e valor) var cep = comando.CreateParameter();
    ...
    public void Update(Logradouro dado)
    {
        ...
        using var comando = factory.CreateCommand(); //Cria comando
        comando!.Connection = conexao; //Atribui conexão
        var id = comando.CreateParameter();//Adiciona parâmetro (@campo e valor) var id = comando.CreateParameter();
        id.ParameterName = "@id";
        id.Value = dado.Id;
